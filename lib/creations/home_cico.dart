...
import 'detail_cico.dart';

class HomeCico extends StatefulWidget {
  final Utilisateur utilisateur;
  const HomeCico({super.key, required this.utilisateur});

  @override
  State<HomeCico> createState() => _HomeCicoState();
}

class _HomeCicoState extends State<HomeCico> {
  bool isLoading = true;
  bool hasError = false;
  List<dynamic> data = [];
