...
class DetailZebra extends StatefulWidget {
  ...
  @override
  State<DetailZebra> createState() => _DetailZebraState();
}

class _DetailZebraState extends State<DetailZebra> {
  List<dynamic> data = [];
  ...
  void filterList(String text) {
    ...
    setState(() {
      filtered = data.where((item) {
        ...
        return nom.contains(text) || phone.contains(text);
      }).toList();
    });
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Zebra - ${widget.libelle} (${widget.cumul})"),
                          ...
                          child: ListTile(
                            ...
                            subtitle: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  "Parent Msisdn : ${item["parent_msisdn"]}",
                                ),
