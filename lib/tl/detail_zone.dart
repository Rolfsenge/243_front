...
import 'detail_secteur_tl.dart';

class DetailZone extends StatefulWidget {
  ...
  @override
  State<DetailZone> createState() => _DetailZoneState();
}

class _DetailZoneState extends State<DetailZone> {
  ...
  Future<Map<String, dynamic>> fetchDashboard() async {
    final response = await http.post(
      Uri.parse(API.getCanalTlZone),
      body: {'region': widget.region},
    );
