...
import 'package:gtm/tl/detail_acq_tl.dart';
import 'package:http/http.dart' as http;

import '../api_connection/api_connection.dart';
import '../tools/color.dart';

class DetailSecteurTl extends StatefulWidget {
  final Utilisateur utilisateur;
  final String zone;
  const DetailSecteurTl({
    super.key,
  ...
  @override
  State<DetailSecteurTl> createState() => _DetailSecteurState();
}

class _DetailSecteurState extends State<DetailSecteurTl> {
  ...
  Future<Map<String, dynamic>> fetchDashboard() async {
    final response = await http.post(
      Uri.parse(API.getCanalTlSecteur),
      body: {'zone': widget.zone},
    );
