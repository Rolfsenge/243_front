...
class RevenuSiteRegion extends StatefulWidget {
  final Utilisateur utilisateur;
  final String groupe_m_usd;
  final String region;
  final Color color;
  final String total;
  const RevenuSiteRegion({
    super.key,
  ...
  @override
  State<RevenuSiteRegion> createState() => _RevenuSiteRegionState();
}

class _RevenuSiteRegionState extends State<RevenuSiteRegion> {
  bool isLoading = true;
  List<dynamic> data = [];
