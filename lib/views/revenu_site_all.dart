...
import 'detail_region_page.dart';

class RevenuSiteAll extends StatefulWidget {
  ...
  @override
  State<RevenuSiteAll> createState() => _RevenuSiteAllState();
}

class _RevenuSiteAllState extends State<RevenuSiteAll> {
  bool isLoading = true;
  List<dynamic> data = [];
  ...
  Future<void> fetchData() async {
    try {
      final url = Uri.parse(API.getRevenuSiteAll);
      final response = await http.post(
        url,
        body: {"total": widget.total, "groupe_m_usd": widget.groupe_m_usd},
      );
